...
public class UserManageDaolmpl extends FactoryDao implements UserManageDao {
    ...
    public synchronized User login(User user) {
        ...
        return (User) dc.getExecutableCriteria(super.getSession())
    ...
    public boolean checkName(String name) {
        ...
        dc.setProjection(field);
        User data = (User) dc.getExecutableCriteria(super.getSession())
                .setResultTransformer(Transformers.aliasToBean(User.class))
                .uniqueResult();
        if (data == null) {
            return true;
